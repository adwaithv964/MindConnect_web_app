...
const GoalProgressCard = ({ goals, onManageGoals }) => {
  return (
    <div className="glass-card p-6">
        ...
        {goals?.map((goal) => (
          <div key={goal?.id} className="space-y-2">
            ...
            <div className="flex items-center justify-between text-xs text-muted-foreground">
              <span>{goal?.completed} of {goal?.total} tasks completed</span>
      ...
      <div className="p-3 bg-success/10 rounded-lg mb-4">
        <div className="flex items-center gap-2">
          ...
          <div>
            <p className="text-sm font-medium text-success">7-Day Streak!</p>
